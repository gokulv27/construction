    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.EmailField(max_length=254, unique=True, verbose_name='Username (Email)')),
                ('role', models.CharField(choices=[('Admin', 'Admin'), ('Supervisor', 'Supervisor'), ('Client', 'Client')], default='Client', max_length=50, verbose_name='Role')),
